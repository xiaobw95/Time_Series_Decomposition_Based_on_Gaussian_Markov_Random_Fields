...
- `R`: Load [`.RData`](https://drive.google.com/open?id=1GYXclPtDxktqYuRcGUjs-4NzGaggKpg-), open `doc/Time-Series-Decomposition-Based-on-Markov-Random-Fields.Rmd` and knit the file.
