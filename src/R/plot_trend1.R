...
#' @param obstype Name of probability distribution of observations.  This controls the back-transformation of the process parameters.  Possible obstypes are 'normal', 'poisson', 'binomial', or 'coalescent'. Assumed link functions are the log for 'poisson' and 'coalescent', and logit for 'binomial'.
...
#' @export
#'
plot_trend1 <- function(theta=NULL, mfit=NULL,  obstype="normal", alpha=0.05, obsvar=NULL, uxvar=NULL, xvar=NULL, colset="blue", trend.col=NULL, trend.lwd=3, bci.col=NULL, pt.col="gray60", pt.pch=1, pt.cex=1, ylab, xlab, main, ylim, xlim, ...){
  ...
  if (!is.null(obsvar)) points(xvar[1:150], obsvar[1:150], pch=pt.pch, col=pt.col,  cex=pt.cex)
  points(xvar[151:162], obsvar[151:162], pch=pt.pch, col=1,  cex=pt.cex)
  lines(uxvar[1:151], thp$postmed[1:151], col=tcol, lwd=trend.lwd)
  lines(uxvar[151:162], thp$postmed[151:162], col=2, lwd=trend.lwd)
